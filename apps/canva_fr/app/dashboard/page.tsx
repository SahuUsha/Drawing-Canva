    ...
    <div className='bg-black min-h-screen min-w-screen  bg-gradient-to-br from-gray-900 via-purple-900/20 to-blue-900/20'>
        ...
        <div className='pt-32'>
            <div className='flex flex-col top-6 items-center justify-center mb-11'>
                ...
                <p className='text-slate-400 text-xl'>Join collaborative drawing rooms with your friends</p>
            </div>
            <div className='flex flex-wrap justify-center gap-5 p-5 '>
                {
                    allRooms.length> 0 ? allRooms.map((room :any) => (<div key={room.id}>
                        <RoomCard  creatorName={room.admin?.name} slug={room.slug} roomId={room.id}  />
                    </div>)) : <div className='text-xl text-emerald-300 '>No Rooms Here, Create New Room</div>
                }
